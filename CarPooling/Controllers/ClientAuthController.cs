...
namespace CarPooling.Controllers
{
    ...
    public class ClientAuthController : Controller
    {
        ...
        public ClientAuthController(IAuthRepository authRepository, IConfiguration iConfiguration)
        {
        ...
        public async Task<IActionResult> Register([FromBody] DriverForRegisterDto userForRegisterDto)
        {
            ...
            //register
            var registeredUser = await _authRepository.Register(user, userForRegisterDto.Password, Models.enums.UserType.Client);
        ...
        public async Task<IActionResult> Login([FromBody]  DriverForLoginDto userForLoginDto)
        {
            ...
            var userFromRepo = await _authRepository.Login(userForLoginDto.Email, userForLoginDto.Password,Models.enums.UserType.Client);
